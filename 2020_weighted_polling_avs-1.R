...
# Import data sets
historical_senate_polls <- read_csv("senate_polls.csv")
...
historical_senate_polls$fte_grade[is.na(historical_senate_polls$fte_grade)] <- 'Z'
                                                                                                                  ...
                                                                                                                  ifelse(historical_senate_polls$fte_grade == "C", 3/91,
                                                                                                                         ifelse(historical_senate_polls$fte_grade == "C-", 2/91,
                                                                                                                                ifelse(historical_senate_polls$fte_grade == "C/D", 1/91,
                                                                                                                                       ifelse(historical_senate_polls$fte_grade == "Z", 1/91,
                                                                                                                                              1/91))))))))))))))
...
dems_only <- subset(weighted_poll_av, party == "DEM")


write.csv(weighted_poll_av,"/Users/madeleineroberts/rWorkingDirectory/2020_weighted_poll_av.csv", row.names = FALSE)
